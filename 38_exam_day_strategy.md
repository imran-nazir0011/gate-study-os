...
The day of the exam tests emotional control and spatial interface efficiency above pure intellectual recall. You are stepping into a highly monitored physical environment under absolute 180-minute constraints. 
...
```mermaid
timeline
    title The 3-Pass Exam Traversal Flow
    Pass 1 : 00:00 - 00:40 : General Aptitude & 1-Mark Scan : Secure GA 15 Marks + absolute direct hits : Overcome limbic setup tension instantly
    Pass 2 : 00:40 - 02:00 : The Heavy Concept Engine : Attack complex 2-Mark MCQs and standard NATs : Box sub-steps; log clear trace trees
    Pass 3 : 02:00 - 02:45 : MSQ Proofs & Derivation Sweeps : Evaluate individual options as True/False checks : Ensure exhaustive boundary parsing
    Buffer : 02:45 - 03:00 : Final Precision Sweeps : Re-verify virtual keypad numeric entries : Confirm exact unit alignments
```
...
- **Virtual Calculator Multi-Tap Guard:** The digital interface calculator experiences input latency. Always click keys slowly and verify the registered input strings directly on screen before executing calculation commands.
...
2. **Post-Exam Discussion Loops:** Once the morning shift paper concludes, **exit the facility immediately.** Do not analyze paper configurations or compare key mappings with extraneous candidates. Protect your neurological state for subsequent targeted admission tracks.
