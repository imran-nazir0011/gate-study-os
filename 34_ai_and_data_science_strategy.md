...
Within **GATE DA 2027 and 2028**, Artificial Intelligence acts as a highly structural, deterministic algorithmic module. Examiners test AI capabilities primarily through **search space execution tracing**—providing explicit conceptual tree structures or graph configurations with customized heuristic costs and demanding step-by-step resolution of optimal goal paths.
...
Setters evaluate AI logic capability by forcing translation of real-world conceptual statements into formal resolution proofs.
...
1. **Ignoring Tie-Breaking Logic:** When tracing A* tree expansions on plain paper, multiple child nodes may evaluate to identical minimum cost values $f(n)$. Setters frequently define explicit tie-breaking rules (*"Resolve alphabetical node ties by selecting the rightmost path"*). Follow explicit custom instructions to trace final visited node sequences.
